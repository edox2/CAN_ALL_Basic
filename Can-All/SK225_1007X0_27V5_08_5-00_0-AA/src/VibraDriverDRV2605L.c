...
uint8_t LraVibraCalibrate(uint8_t Channel, uint8_t BaseAddress)
{
    ...
    DataToWrite[1] = 70; //70 1.4V RMS //90: Rated Voltage 1.8V RMS @f0=235Hz  // (before 85; // Rated Voltage 2.1Vrms)
    DataToWrite[2] = 84; // 84: 1.8V //89: Open Loop Clamping Voltage 1.9V for Overdrive // (before 107;// Clamping Voltage 2.1V (for Overdrive))
