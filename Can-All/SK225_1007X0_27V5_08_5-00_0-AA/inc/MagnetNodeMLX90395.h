...
#define TOGGLE_CBUS_METERINIT 0// Make restart of Magentometer on TOGGLE_PIN pin
#define TOGGLE_CBUS_METER 0// Make successful internal update process visible on TOGGLE_PIN pin
#define TOGGLE_PIN DBG_LED
