...
;
;
; 	FILE NAME  	: c51f550_hal.h
; 	TARGET MCUs	: C8051F5xx,
; 	DESCRIPTION	: Register/bit definitions for the Silabs c8051f5xx product family.
;
;
;---------------------------------------------------------------------------*/
...
#ifndef  _C51F550HAL_H_
#define  _C51F550HAL_H_

#include <SI_C8051F550_Register_Enums.h>// SFR declarations
SBIT (nLED_RED, SFR_P0, 2);                 // nLED='1' means OFF
SBIT (nLED_GREEN, SFR_P0, 3);               // nLED='1' means OFF
SBIT (X_IN, SFR_P1, 7);                     // Set go GND
SBIT (PB_IN, SFR_P2, 0);                    // Set go GND
SBIT (VAR_POT, SFR_P1, 5);                  // AnalogIn
SBIT (CH_ID, SFR_P0, 0);                    // CH_ID='1' means CHANNEL-A
SBIT (nOUT_RED, SFR_P0, 4);                 // nLED='1' means OFF
SBIT (nOUT_GREEN, SFR_P0, 5);               // nLED='1' means OFF
...
//
///* CAN0STA 0xC0 */
//sbit BOFF   = CAN0STAT ^ 7;          /* Bus Off Status                  */
//sbit EWARN  = CAN0STAT ^ 6;          /* Warning Status                  */
//sbit EPASS  = CAN0STAT ^ 5;          /* Error Passive                   */
//sbit RXOK   = CAN0STAT ^ 4;          /* Received Message Successfully   */
//sbit TXOK   = CAN0STAT ^ 3;          /* Transmit a Message Successfully */
//sbit LEC2   = CAN0STAT ^ 2;          /* Last error code bit 2           */
//sbit LEC1   = CAN0STAT ^ 1;          /* Last error code bit 1           */
//sbit LEC0   = CAN0STAT ^ 0;          /* Last error code bit             */
//
//
///*  TMR2CN  0xC8 */
